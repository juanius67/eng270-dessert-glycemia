...
def write_json(path: Path, payload: Dict[str, object]) -> None:
    ...
    Args:
        ...
        payload (Dict[str, object]): Data to write.
...
def collect_env_metadata() -> Dict[str, object]:
    """Collects metadata about the current Python environment.

    Returns:
        Dict[str, object]: Dictionary containing environment metadata (Python version, NumPy version, OS).
